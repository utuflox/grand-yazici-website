    ...
    >
      ...
      >
        <video
          ...
          loop
          playsInline
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[177.78vh] h-screen min-w-full min-h-[56.25vw] object-cover pointer-events-none opacity-45"
        />
      </motion.div>
